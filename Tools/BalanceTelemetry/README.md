...
```powershell
python Tools/BalanceTelemetry/import_telemetry.py import --input Saved/Logs/DroneProto.log --db Saved/BalanceTelemetry/balance.db --source-commit HEAD
python Tools/BalanceTelemetry/import_telemetry.py export --db Saved/BalanceTelemetry/balance.db --output Saved/BalanceTelemetry/export
python Tools/BalanceTelemetry/import_telemetry.py prune --db Saved/BalanceTelemetry/balance.db --older-than-days 90
```
